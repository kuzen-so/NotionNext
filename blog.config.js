...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kuzen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '努力学画画的coder', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.kuzen.top', // 网站地址
